...
const Wireframe1: NextPage = () => {
  return (
    <div className="w-full relative rounded-26xl [background:linear-gradient(79.61deg,_#ff1102,_#efbf04)] h-[900px] overflow-hidden text-left text-5xl text-black font-poppins">
      ...
      <div className="absolute top-[48px] left-[calc(50%_-_656px)] shadow-[45.7px_-45.7px_45.73px_rgba(165,_165,_165,_0.1)_inset,_-45.7px_45.7px_45.73px_rgba(255,_255,_255,_0.1)_inset] [backdrop-filter:blur(91.47px)] rounded-26xl bg-gainsboro-300 w-[1296px] h-[60px]" />
      ...
      <div className="absolute top-[203px] left-[33px] text-109xl font-extrabold text-white inline-block w-[572px] h-[204px]">
        Gamble
      </div>
      <div className="absolute top-[336px] left-[33px] text-109xl font-extrabold">
        BitBet
      </div>
      <div className="absolute top-[515px] left-[41px] text-mini font-extrabold text-transparent !bg-clip-text [background:linear-gradient(96.13deg,_#fff,_#fff_17.6%,_#fffefe_37.6%,_#8e8d8d_46.91%,_#000_53.5%,_#0b0a0a)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] inline-block w-[693px] h-[92px]">
      ...
      <div className="absolute top-[690px] left-[179px] rounded-26xl bg-black w-[140px] h-[52px]" />
      <div className="absolute top-[695px] left-[218px] font-extrabold text-white inline-block w-20 h-[42px]">
        Play
      </div>
      <img
        className="absolute top-[141px] left-[628px] w-[794px] h-[680px] object-cover"
        alt=""
        src="/-64e8bc80af9f4a218ad191d510322b4fremovebgpreview-2@2x.png"
      />
      <img
        className="absolute top-[268px] left-[854px] w-[390px] h-[365px] object-cover"
        alt=""
